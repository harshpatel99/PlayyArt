...
class LikedFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val recyclerView = view.findViewById<RecyclerView>(R.id.profileLikedRecyclerView)
        shimmerFrameLayout = view.findViewById(R.id.likedShimmerLayout)

        val noItemView = view.findViewById<View>(R.id.likedNoItem)
        ...
        noItemImageView.setImageResource(R.drawable.ic_heart_24_regular)
        noItemTextView.text = getString(R.string.liked_empty_text)
